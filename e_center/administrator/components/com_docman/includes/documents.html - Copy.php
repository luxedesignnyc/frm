    ...
    function _showTabBasic(&$row, &$lists, &$last, &$created)
    {
		...
		<tr>
         ...
         <tr>
            ...
            <td colspan="2">
                 <?php echo DOCMAN_Compat::calendar('ngay_ky', $row->ngay_ky);?>
            </td>
        </tr>
         <tr>
        ...
        <tr>
            ...
            <td colspan="2">
                 <?php echo DOCMAN_Compat::calendar('ngay_hieu_luc', $row->ngay_hieu_luc);?>
            </td>
        </tr>
         <tr>
            <td width="250" align="right"><?php echo _DML_NGAYHETHIEULUC;?></td>
            <td colspan="2">
                 <?php echo DOCMAN_Compat::calendar('ngay_het_hieu_luc', $row->ngay_het_hieu_luc);?>
            </td>
        </tr>					
        <?php if (!$row->approved) {?>
        <tr>
