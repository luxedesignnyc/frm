...
class HTML_DMFiles
{
	...
	//TUYEN: fixed this function to upload file
    function uploadWizard_http($old_filename = null)
    {
		...
		<form action="index2.php?option=com_docman&section=files&task=upload&step=3&method=http&old_filename=<?php echo $old_filename;?>&document_id=<?php echo JRequest::getVar('document_id', 0, 'get', 'string'); ?>" method="post" enctype="multipart/form-data" onSubmit="MM_showHideLayers('Layer1','','show')" name="fm_upload">
		...
		<script type="text/javascript">
			function submitButton () {
				document.fm_upload.action = document.fm_upload.action + "&reason=" + document.fm_upload.reason.value;
				document.fm_upload.submit();				
			}
		</script>
	   ...
	   <td>
	    ...
	    <td align="left">
            ...
            <td align="center"><div align="left">
				Reason <textarea name="reason" id="reasonId" rows="10"></textarea>
				<input type="button" value="<?php echo _DML_SUBMIT ?>" onclick="submitButton()" />
            </td>
        </tr>
      </table>
    <?php echo DOCMAN_token::render();?>
