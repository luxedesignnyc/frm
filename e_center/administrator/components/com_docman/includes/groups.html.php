        ...
        <form action="index2.php" method="post" name="adminForm" id="adminForm">
			...
			<fieldset class="adminform">
                ...
                <table class="admintable" width="100%">
					<tr>
						<td class="key" width="20%" align="right"><?php echo _DML_GROUP;?>:</td>
						<td width="80%">
					...
					<tr>
						<td class="key" valign="top" align="right"><?php echo _DML_DESCRIPTION;?></td>
						<td valign="top">
            ...
            <div class="button_up_down">
               <table cellpadding="4" cellspacing="1" border="0" width="100%" class="adminform">
					...
					<tr>
                        <td  colspan="3">
                            <?php echo _DML_USERS_AVAILABLE;?><br />
							<?php echo $toAddUsersList;?>
					...
					<tr>
                        <td colspan="3">
							<div class="bt">
								<input class = "down" type="button" name="Button" onClick="moveOptions(document.adminForm.users_not_selected, document.adminForm['users_selected[]'])" />
								
								<input class = "up"  type="button" name="Button" onClick="moveOptions(document.adminForm['users_selected[]'],document.adminForm.users_not_selected)" />
							</div>
                        </td>
                    </tr>
					...
					<tr>
                        <td  colspan="3">
                            <?php echo _DML_MEMBERS_IN_GROUP;?><br />
							<?php echo $usersList;?>
