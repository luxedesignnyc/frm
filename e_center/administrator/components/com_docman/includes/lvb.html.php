...
class HTML_DMLVBCategories
{
    function show(&$rows, $myid, &$pageNav, &$lists, $type)
    {
		...
		<tr>
			...
			<th class="title"><?php echo _DML_LVB;?></th>
			<th width="15%"><?php echo _DML_CATNAME;?></th>
		...
		<input type="hidden" name="section" value="lvb" />
    ...
    function edit(&$row, $section, &$lists, $redirect)
    {
		...
		<tr>
			<td valign="top">
				...
				<tr>
					<td align="right"><?php echo _DML_SECTIONS;?>:</td>
					<td>
				...
				<tr>
					<td align="right"><?php echo _DML_PARENT_CATEGORIES;?>:</td>
					<td>
		...
		<script language="javascript" type="text/javascript">			
			insertArrray ('parent_id');
			loopSelected('catid', 'parent_id');
		</script>
