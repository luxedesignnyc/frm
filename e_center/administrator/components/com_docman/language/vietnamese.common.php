...
define('_DML_SECTIONS', "Sections");
define('_DML_REQUESTS', "Requests");
define('_DML_SENDER', "Sender");
define('_DML_DOC_DISTRIBUTION', "Documents distribution");
define('_DML_UPLOADING_DATE', "Uploading Date");
define('_DML_REASON', "Reason");
define('_DML_STATUS', "Status");
define('_DML_TRACK', "Track");
define('_DML_READ', "Read");

define('_DML_PARENT_CATEGORIES', "Parent categories");
define('_DML_TENVB', "Document name");
define('_DML_DATE', "Date");
define('_DML_DATE_MODIFIED', "Modified date");
define('_DML_HITS', "Hits");
define('_DML_SIZE', "Size");
define('_DML_EXT', "Type of file");
...
define('_DML_CAT', "Sections");
define('_DML_CQBH', "Issuing agency");
define('_DML_LVB', "Categories");
define('_DML_NGAYKY', "Signed date");
define('_DML_NGUOIKY', "Signer");
define('_DML_NGAYHIEULUC', "Effective date");
define('_DML_NGAYHETHIEULUC', "Expiration date");
define('_DML_CATS', "Categories");
define('_DML_CATEGORY', "Category");

define('_DML_STT', "STT");
define('_DML_SO_VB', "Số văn bản");
define('_DML_LOAI_CV', "Loại công văn");
define('_DML_NGAY_CV', "Ngày công văn");
define('_DML_CQBH_1', "CQ ban hành");
define('_DML_NOIDUNG', "Nội dung");
define('_DML_XU_LY', "Xử lý");
...
define('_DML_APPROVED', "Approve");
define('_DML_DELETED', "Deleted");

define('_DML_INSTALL', "Install");
define('_DML_PUBLISHED', "Publish");
...
// -- File Class
define('_DML_OPTION_HTTP', "Upload file t&#7915; m&#225;y ");
define('_DML_OPTION_XFER', "chuy&#7875;n file t&#7915; server kh&#225;c");
define('_DML_OPTION_LINK', "T&#7841;o &#273;&#432;&#7901;ng li&#234;n k&#7871;t &#273;&#7871;n trang kh&#225;c");
...
define('_DML_SEARCH_CATEGORY', "Section");
...
define('_DML_PROMPT_KEYWORD', "Key words");
