...
<tr>
				<td class='key'>
					...
					<input type='text' name='field' size='35' class='inputbox' value='<?php echo $this->customfield->field;?>' />
				</td>
			</tr><tr>
				<td class='key'>
...
<input type='hidden' name='ret' value='index.php?option=com_jforce&view=customfield' />
