		...
		<td height="54" valign="top">
            <table width="100%" border="0" align="center" class="main" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="10" height="54" class="corner_lt_main" valign="top"></td>
                    <td height="54" class="middle_top_main" valign="top"><div id="title_header"><?php echo $this->lang->line('administrator_header'); ?></div></td>
                    <td width="10" height="54" class="corner_rt_main" valign="top"></td>
                    <td width="2" height="54"></td>
                </tr>
            </table>
		</td>
